...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardDetailCSS/detail4.css?ver=1.18">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardDetailJS/detail4.js?ver=1.25"></script>
