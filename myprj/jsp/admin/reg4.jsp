...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardRegCSS/reg4.css?ver=1.04">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardRegJS/reg4.js?ver=1.04"></script>
<title>게시글 등록</title>
