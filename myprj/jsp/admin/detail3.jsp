...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardDetailCSS/detail3.css?ver=1.20">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardDetailJS/detail3.js?ver=1.25"></script>
