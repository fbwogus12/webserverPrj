...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardListCSS/photoList1.css?ver=1.12">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardListJS/photoList1.js?ver=1.02"></script>
