...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardDetailCSS/detail1.css?ver=1.00">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardDetailJS/detail1.js?ver=1.00"></script>
										...
										<td style="text-align: left;">
											<ul type="square">
												<c:forTokens var="fileName" items="${b.files }" delims=","
													varStatus="st">
													<c:if test="${fn:split(fileName,'.')[1] ne 'yt'}">
