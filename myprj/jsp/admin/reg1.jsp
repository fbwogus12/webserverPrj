...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/board/adminBoardRegCSS/reg1.css?ver=1.10">
<link
...
<script
	src="${pageContext.request.contextPath}/js/admin/board/adminBoardRegJS/reg1.js?ver=1.37"></script>
<title>게시글 등록</title>
