...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardModCSS/mod3.css?ver=1.01">
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardModJS/mod3.js?ver=1.04"></script>
			...
			<div class="main-content">
				<div class="main-container">
					<div class="main-header">
						...
						<fieldset>
							<form method="post" action="/board/mod" id='reg-form'>
										...
										<tbody>
											...
											<tr>
												...
												<td><div class="media_div">
														<span class="yt_btn">유튜브 업로드</span>
											...
											<tr class="content-style">
												...
												<td class="text_td">
													<div class="org_preview">
																...
																<c:if test="${status.last}">
																	<c:choose>
																		<c:when test="${token eq 'yt'}">
																			<div class="del_${fileName}">
																				<span style="float: left; font-weight: bolder;"
																					class="del_preview">ⓧ</span>
																				<iframe id="player" class="slide_video" width="700"
																					height="400"
														...
														<c:if test="${b.files ne null && b.files ne ''}">
															<hr />
														</c:if>
													</div>
									...
									<div class="reg-footer">
										...
										<div class="hidden">
											...
											<div id="org_yt">
												<c:forTokens var="fileName" items="${b.files }" delims=","
													varStatus="st">
													<c:if test="${fn:split(fileName,'.')[1] eq 'yt'}">
														<span>${fn:split(fileName,'.')[0]}</span>
													</c:if>
												</c:forTokens>
											</div>
										</div>
