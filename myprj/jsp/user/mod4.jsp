...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardModCSS/mod4.css?ver=1.01">
<title>게시글 수정</title>
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardModJS/mod4.js?ver=1.01"></script>
</head>
