...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardListCSS/videoList1.css?ver=1.01">
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardListJS/videoList1.js?ver=1.02"></script>
<title>영상 게시판</title>
</head>
				...
				<div class="main-container">
					<div class="main-header">
						<div class="header-name">
							<h1>
								<a href="/admin/board/list?board=${param.board}">영상게시판</a> <span>
									<c:if test="${param.board eq '4'}">-영상1</c:if> <c:if
										test="${param.board eq '14'}">-영상2</c:if> <c:if
										test="${param.board eq '24'}">-영상3</c:if>
								</span>
							</h1>
						</div>
					...
					<div class="board-list">
						<table class="board-table">
							<caption class="blind">영상게시판</caption>
								...
								<c:forEach var="b" items="${list}">
									<div class="photo_style" style="position: relative;">
										<div class="img_style">
											...
											<a
												href="/board/detail?board=${param.board}&id=${b.id}&p=${empty param.p?1:param.p}&f=${param.f}&q=${param.q}">
