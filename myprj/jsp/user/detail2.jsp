...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardDetailCSS/detail2.css?ver=1.00">
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardDetailJS/detail2.js?ver=1.00"></script>
