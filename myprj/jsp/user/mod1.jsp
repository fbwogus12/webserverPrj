...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardModCSS/mod1.css?ver=1.01">
<title>게시글 수정</title>
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardModJS/mod1.js?ver=1.00"></script>
</head>
