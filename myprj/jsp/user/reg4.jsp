...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardRegCSS/reg4.css?ver=1.00">
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardRegJS/reg4.js?ver=1.00"></script>
<title>게시글 등록</title>
				...
				<div class="main-container">
					<div class="main-header">
						<div class="header-name">
							<h1>
								<a href="/board/list?board=${param.board}">사진게시판</a><span>
									<c:if test="${param.board eq '3'}">-개인</c:if> <c:if
										test="${param.board eq '13'}">-단체</c:if> <c:if
										test="${param.board eq '23'}">-기타</c:if>
								</span>
							</h1>
						</div>
						<fieldset>
