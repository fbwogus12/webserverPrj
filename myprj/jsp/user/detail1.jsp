...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/board/boardDetailCSS/detail1.css?ver=1.01">
<link
...
<script
	src="${pageContext.request.contextPath}/js/board/boardDetailJS/detail1.js?ver=1.01"></script>
